...
#define PED_CAM_ROTATION MENUACTION_CFO_PEDCAMROT, "FET_CAM", { new CCFOSelect((int8*)&TheCamera.m_bEnablePedCamRotation, "Controller", "EnablePedCamRotation", off_on, 2, false) },
...
CMenuScreenCustom aScreens[MENUPAGES] = {
   ...
   { "FEG_MAP", MENUPAGE_NONE, MENUPAGE_NONE, nil, nil,
	...
	{ "FET_GRA", MENUPAGE_OPTIONS, MENUPAGE_OPTIONS,
		new CCustomScreenLayout({FE_1, 320, 0, 24, FONT_HEADING, FESCREEN_LEFT_ALIGN, false, 0.48f, 1.0f}), GraphicsGoBack,
	...
	{ "FEC_JOD", MENUPAGE_CONTROLLER_PC, MENUPAGE_CONTROLLER_PC,
	   	new CCustomScreenLayout({FE_1, 320, 0, 24, FONT_HEADING, FESCREEN_LEFT_ALIGN, false, 0.48f, 1.0f}), DetectJoystickGoBack,
