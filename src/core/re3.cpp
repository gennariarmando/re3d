...
bool LoadINISettings()
{
	...
	ReadIniIfExists("Controller", "EnablePedCamRotation", &TheCamera.m_bEnablePedCamRotation);
...
void SaveINISettings()
{
	...
	StoreIni("Controller", "EnablePedCamRotation", TheCamera.m_bEnablePedCamRotation);
