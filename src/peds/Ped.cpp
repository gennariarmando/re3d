...
{
	CAnimBlendAssociation *newAssoc = CAnimManager::BlendAnimation(GetClump(), ASSOCGRP_STD, ANIM_STD_PARTIAL_FUCKU, 2.0f);
	...
	for(int i = 0; i < m_numNearPeds; ++i) {
		...
		if((nearPed->GetPosition() - GetPosition()).MagnitudeSqr() > sq(5.0f))
			break;
